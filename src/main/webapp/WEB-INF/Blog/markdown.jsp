...
<body>
    <div style="display: none;">
        <span id="articleId">${article.articleId}</span>
        <c:forEach items="${article.articleClasses}" var="ac">
            <span name="ac">${ac.personalClassification.classificationId}</span>
        </c:forEach>
    </div>
    <div class="mark-head">
        <input id="articleTitle" value="${article.articleTitle}" name="article.articleTitle" placeholder="文章标题"/>
    ...
    <div class="suEditor">
        <textarea name="article.articleContent" class="text-input" oninput="markdown.change()" id="inputText" placeholder="正文">${article.articleContent}</textarea>
    </div>
<div class="suPreview" id="preview"></div>
    <div class="help" >
        <div class="help-head">
                ...
                <form id="settingForm" class="form-horizontal" style="margin-bottom: 0px;">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" style="margin-top:20px;">
                            ...
                            <div class="col-lg-7">
                                <s:if test="#session.user.personalClassifications.size() <= 0">
                                    <font color="red">请先创建分类!</font>
                                </s:if>
                                <s:if test="#session.user.personalClassifications.size() > 0">
                                    <c:forEach items="${sessionScope.user.personalClassifications}" var="cl" varStatus="i">
                                        <div style="float:left;margin-right:15px;">
                                            <!-- ognl表达式需要集合struts2标签来使用，不方便，
                                            而且无法在name值里面使用ognl表达式，也就无法动态的给name赋值
                                            后台就无法接受到数据 -->
                        ...
                        <div class="form-group" style="margin-top:20px;">
                            ...
                            <div class="col-lg-7">
                                <select class="form-control" name="article.classification">
                                    <option value="">-- 请选择 --</option>
                        ...
                        <div class="form-group" style="margin-top:20px;">
                            ...
                            <div class="col-lg-7">
                                <input value="${article.tag}" class="form-control" name="article.tag" />
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="margin-top:20px;">
                            ...
                            <div class="col-lg-7">
                                <textarea id="articleSummary" value="${article.articleSummary}" cols="34" name="article.articleSummary" rows="10" ></textarea>
                            </div>
                        </div>
